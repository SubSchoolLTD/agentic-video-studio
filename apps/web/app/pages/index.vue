...
const showcaseVideos = [
  ...
  { src: '/showcase/framewise-example-04.mp4', poster: '/showcase/framewise-example-04.jpg', youtube: 'https://youtube.com/shorts/emNzYSO0NeM', label: 'Production example 04', format: 'Creator-led UGC · 55 seconds' },
]
  ...
  <div class="landing">
    <header class="landing-header">
      ...
      <div v-if="menuOpen" class="landing-mobile-nav">
        ...
        <span class="landing-mobile-nav__label">Solutions</span>
        <NuxtLink to="/solutions/studios-media-teams" @click="menuOpen = false">Studios &amp; media teams</NuxtLink>
        <NuxtLink to="/solutions/creators-experts" @click="menuOpen = false">Creators &amp; experts</NuxtLink>
        <NuxtLink to="/solutions/small-businesses" @click="menuOpen = false">Small businesses</NuxtLink>
        <NuxtLink to="/solutions/education-teams" @click="menuOpen = false">Education teams</NuxtLink>
      ...
      <section id="examples" class="landing-section landing-showcase">
        <div class="landing-container">
          <div class="showcase-intro">
            <div><span class="landing-eyebrow">Real Framewise productions</span><h2>From an idea to a video worth watching.</h2></div>
            <p>Run on autopilot or refine individual takes. These real examples show both fully autonomous productions and a creator-led video refined with scene-level regeneration—all in one workflow.</p>
          </div>
    ...
    <footer class="landing-footer">
      <div class="landing-container landing-footer__grid">
        ...
        <div><strong>Solutions</strong><NuxtLink to="/solutions/studios-media-teams">Studios &amp; media</NuxtLink><NuxtLink to="/solutions/creators-experts">Creators &amp; experts</NuxtLink><NuxtLink to="/solutions/small-businesses">Small businesses</NuxtLink><NuxtLink to="/solutions/education-teams">Education teams</NuxtLink></div>
