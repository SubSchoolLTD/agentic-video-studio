...
const generation = reactive({ visual_mode: 'ugc_creator', audio_mode: 'google_tts', continue_scenes: true, native_voice_preset: 'warm_conversational', character_id: '', aspect_ratios: ['9:16'] as string[], target_duration_seconds: 30, approval_mode: 'final_only', variants: 1, burn_in_captions: false, max_cost_usd: 30 })
