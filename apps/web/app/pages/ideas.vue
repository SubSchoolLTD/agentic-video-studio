...
import { ArrowRight, Columns3, List, Plus, Search, Sparkles, WandSparkles, X } from 'lucide-vue-next'
...
const columns = computed(() => [
  ...
  { key: 'planned', label: 'Planned', items: filteredIdeas.value.filter((item: any) => item.status === 'planned') },
])
