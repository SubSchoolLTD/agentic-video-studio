...
const form = reactive({ title: '', hook: '', audience: '', objective: 'awareness', visual_mode: 'ugc_creator', audio_mode: 'google_tts', character_id: '' })
const generation = reactive({ visual_mode: 'ugc_creator', audio_mode: 'google_tts', character_id: '', aspect_ratios: ['9:16'] as string[], target_duration_seconds: 30, approval_mode: 'final_only', variants: 1, burn_in_captions: false, max_cost_usd: 30 })
...
const audioModes = [
  ...
  { value: 'veo_native', label: 'Veo 3 native voice', description: 'Each Veo scene generates its own speech and sound, then transcription QA checks completeness.' },
]
...
async function saveIdea() {
  ...
  try {
    ...
    Object.assign(form, { title: '', hook: '', audience: '', objective: 'awareness', visual_mode: 'ugc_creator', audio_mode: 'google_tts', character_id: '' })
