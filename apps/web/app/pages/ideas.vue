...
const audioModes = [
  ...
  { value: 'veo_native', label: 'Veo 3 native voice', description: 'Veo generates synchronized speech. One locked voice profile and seed are reused, then every later scene is compared with the opening voice.' },
]
