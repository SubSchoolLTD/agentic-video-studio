...
const generation = reactive({ visual_mode: 'ugc_creator', character_id: '', aspect_ratios: ['9:16'] as string[], target_duration_seconds: 30, approval_mode: 'final_only', variants: 1, burn_in_captions: false, max_cost_usd: 30 })
...
const generationFeature = computed(() => generation.visual_mode === 'ugc_native_audio' ? 'video.generate_native_audio' : 'video.generate')
